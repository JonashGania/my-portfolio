...
const About = () => {
  return (
    <div className="flex-1 ">
      <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 duration-100 transition-colors ease-in-out">
        About
      </h2>
      <p className="text-sm text-zinc-700 dark:text-zinc-300 duration-100 transition-colors ease-in-out">
        Hello there! I&apos;m Jonash Gaña a Full Stack Developer and Computer
        Engineering graduate from Pampanga, Philippines.
      </p>
      <p className="text-zinc-700 dark:text-zinc-300 duration-100 transition-colors ease-in-out text-sm pt-4">
