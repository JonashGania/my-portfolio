...
const About = () => {
  return (
    <div className="flex-1 ">
      <h2 className="text-lg font-semibold  duration-100 transition-colors ease-in-out">
        About
      </h2>
      <p className="text-sm leading-relaxed duration-100 transition-colors ease-in-out">
