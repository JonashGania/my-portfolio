              ...
              <li key={index}>
                <div className="grid grid-cols-1 md:grid-cols-8 gap-8 md:gap-4">
                  <div className="order-1 flex justify-center justify-items-center md:order-first col-span-1 md:col-span-3">
                    <div className="w-[340px] md:w-full h-[240px] overflow-hidden rounded-lg border border-zinc-600 relative">
                      <Image 
                        src={proj.imgUrl} 
                        alt="Project image" 
                  ...
                  <div className="col-span-1 md:col-span-5 flex flex-col pl-3 md:pl-10">
                    ...
                    <div className="pb-2 flex items-center">
                      <a
                        href={proj.link}
                        className={`text-gray-500 font-medium flex items-center gap-2 hover:underline decoration-solid ${proj.deployed ? 'cursor-pointer' : 'cursor-not-allowed pointer-events-none'}`}
                      >
                        Link
                        <svg
                            width="18"
                    ...
                    <div className="flex items-center flex-wrap gap-4 pt">
                      {proj.tools.map((tech, index) => (
                        <span
                          key={index}
                          className="text-white text-sm font-medium bg-[#1E293B] px-3 py-1 rounded-xl"
                        >
                          {tech}
                        </span>
                      ))}
