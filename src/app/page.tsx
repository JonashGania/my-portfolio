      ...
      <div className="max-w-960 mx-auto">
        ...
        <div className="pt-40 pb-20 mx-4">
          ...
          <div className=" pt-24">
            <Link
              href={'/projects'}
              className="bg-white flex items-center justify-center gap-2 rounded-md w-32 mx-auto py-3 "
            >
